...
<html>
    <body>
        ...
        <form action="" method="post">
            ...
            <td>Designation :</td>
            <td>
            Junior programmer <input type="radio" name="designation" value="Junior programmer">
            Senior Programmer <input type="radio" name="designation" value="Senior Programmer">
            Project Lead <input type="radio" name="designation" value="Project Lead">
